const START_GRAPH_SCHEMA_SIMULATION = 'START_GRAPH_SCHEMA_SIMULATION';
const STOP_GRAPH_SCHEMA_SIMULATION = 'STOP_GRAPH_SCHEMA_SIMULATION';
const UPDATE_GRAPH_SCHEMA_ELEMENT_POSITIONS = 'UPDATE_GRAPH_SCHEMA_ELEMENT_POSITIONS';
