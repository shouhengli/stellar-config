            ...
            ? (
              <ActiveDropDownMenu
                ...
                handleItemClick={R.partialRight(
                    handleLinkPropValueMenuItemClick,
                    [MAPPING_LINK_SOURCE_KEY, link.get(MAPPING_LINK_SOURCE_KEY)]
                )}
                handleButtonClick={
                  R.partial(
                    handleLinkPropValueButtonClick,
          ...
          <label className="label">@ID</label>
          {
            ...
            ? (
              <ActiveDropDownMenu
                ...
                handleItemClick={R.partialRight(
                    handleLinkPropValueMenuItemClick,
                    [MAPPING_LINK_DESTINATION_KEY, link.get(MAPPING_LINK_DESTINATION_KEY)]
                )}
                handleButtonClick={
                  R.partial(
                    handleLinkPropValueButtonClick,
                  ...
                  <label className="label">Property</label>
                  {
                    ...
                    ? (
                      <ActiveDropDownMenu
                        ...
                        handleItemClick={R.partialRight(handleLinkPropKeyMenuItemClick, [propKey])}
                        handleButtonClick={R.partial(handleLinkPropKeyButtonClick, [propKey])}>
                  ...
                  <label className="label">Column</label>
                  {
                    ...
                    ? (
                      <ActiveDropDownMenu
                        ...
                        handleItemClick={
                          R.partialRight(handleLinkPropValueMenuItemClick, [propKey])
                        }
                        handleButtonClick={R.partial(handleLinkPropValueButtonClick, [propKey])}>
                        <SourceColumnLabel
