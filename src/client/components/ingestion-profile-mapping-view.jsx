...
const Node = ({ node, index, handleEditButtonClick }) => (
  <div className="card">
    <header className="card-header">
      <p className="card-header-title">{node.get(MAPPING_NODE_TYPE_KEY)}</p>
      <a
    ...
    <div className="card-content">
      <h6 className="title is-6">{MAPPING_NODE_ID_KEY}</h6>
...
const Link = ({ link, index, handleEditButtonClick }) => (
  <div className="card">
    ...
    <div className="card-content">
      <h6 className="title is-6">{MAPPING_LINK_SOURCE_KEY}</h6>
      <p className="source-column-label">
        <SourceColumnLabel
      ...
      <h6 className="title is-6">{MAPPING_LINK_DESTINATION_KEY}</h6>
      <p className="source-column-label">
        <SourceColumnLabel
